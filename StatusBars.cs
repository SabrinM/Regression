...
namespace SM
{
    internal class StatusBars
    {
        ...
        {
            StatusBars.barBackground = new Texture2D(Game1.graphics.GraphicsDevice, StatusBars.barWidth, StatusBars.barHeight);
            StatusBars.barForeground = new Texture2D(Game1.graphics.GraphicsDevice, StatusBars.barWidth, StatusBars.barHeight);
